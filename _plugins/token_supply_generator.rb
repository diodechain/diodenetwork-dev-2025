module Jekyll
  class TokenSupplyGenerator < Generator
    ...
    def fetch_circulating_supply
      ...
      "229,172.000000000000000000"

      # Epoch 678 + 2940 on 2025-11-17 --> from already liquid wallet, same circulating 229,172
      # Adding other non locked wallets (despite managed): 229,172
